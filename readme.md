...
Síðurnar mega innihalda hvaða efni sem er, en þær þurfa að nýta eitthvert WebAPI, [sjá námsefni](https://github.com/vefforritun/vef1-2025/tree/main/namsefni/40.html5) eða [lista MDN yfir Web APIs](https://developer.mozilla.org/en-US/docs/Web/API).
